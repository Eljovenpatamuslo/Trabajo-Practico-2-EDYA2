...
-- at runtime using the environment variable src_bindir.
...
-- environment variable src_libdir.
...
-- using the environment variable src_dynlibdir.
...
-- runtime using the environment variable src_datadir.
...
-- using the environment variable src_sysconfdir.
...
bindir     = "/home/pata/.cabal/bin"
libdir     = "/home/pata/.cabal/lib/x86_64-linux-ghc-9.6.7/src-0.1.0.0-inplace-src"
dynlibdir  = "/home/pata/.cabal/lib/x86_64-linux-ghc-9.6.7"
datadir    = "/home/pata/.cabal/share/x86_64-linux-ghc-9.6.7/src-0.1.0.0"
libexecdir = "/home/pata/.cabal/libexec/x86_64-linux-ghc-9.6.7/src-0.1.0.0"
sysconfdir = "/home/pata/.cabal/etc"
